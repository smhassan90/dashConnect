...
//   //   const yourAuthToken = localStorage.getItem("your_access_token");
...
//   //       `${baseUrl}integration/v1/testConnectionIntegration`,
...
//     }
//   };
//   const handleTestConnectionWithLoader = async () => {
//     setWaiting(true); // Loader start karein
//     try {
//       await handleTestConnection(); // API call
//     } finally {
//       setWaiting(false); // Loader stop karein
//     }
//   };
